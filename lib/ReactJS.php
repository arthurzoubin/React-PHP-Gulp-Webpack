...
class ReactJS {
     ...
     */
    function __construct($libsrc, $serversrc, $appsrc) {
        $react = array();
        // stubs, react
        ...
        $react[] = $libsrc;
        $react[] = $serversrc;
        $react[] = "var React = global.React, ReactDOMServer = global.ReactDOMServer;";
        // app's components
        $react[] = $appsrc;
        $react[] = ';';
    ...
    function getMarkup() {
        $js = sprintf(
            "%s = global.page; print(ReactDOMServer.renderToString(React.createElement(%s, %s)))",
            $this->component,
            $this->component,
            $this->data);
